...
.. seealso::
   This section contains the basic information regarding how to configure products for lot and
   serial number tracking. See the documentation on
   :doc:`lots <../../inventory/product_management/product_tracking/lots>` and
   :doc:`serial numbers <../../inventory/product_management/product_tracking/serial_numbers>` for
   more information.

Lot number manufacturing
========================

To manufacture a product tracked with lots, begin by navigating to the
:menuselection:`Manufacturing` app, and select :guilabel:`Operations --> Manufacturing Orders`.
Click :guilabel:`New` to create a new manufacturing order (MO).
...
To manufacture a product tracked with serial numbers, begin by navigating to the
:menuselection:`Manufacturing` app and selecting :guilabel:`Operations --> Manufacturing Orders`.
...
To assign serial numbers to each unit of an |MO|, click :guilabel:`Produce All`. Doing so opens a
