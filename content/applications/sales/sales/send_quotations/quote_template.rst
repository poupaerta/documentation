...
Then, drag and drop the section name to the desired position, via the :icon:`oi-apps` :guilabel:`six
...
:icon:`fa-trash` :guilabel:`trash can` icon on the far-right side of the line.
...
::.. example::
   For example, if a customer wants to buy a car, they have the choice to order massaging seats as
